...
var indexNav = [
    ...
    {
        name: '心里调护',
        url: './pages/xinlitiaohu/list.html'
    },
    {
        name: '医生',
    ...
    {
        name: '中医食疗',
        url: './pages/zongyishiliao/list.html'
    },

]

var adminurl =  "http://localhost:8080/yanglaofuwupingtai/admin/dist/index.html#/login";
